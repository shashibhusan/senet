...
public class InsertAllocation 
{
            ...
            )
    {
        ...
        try
        {
        String Query="insert into tbl_ba_fundallocation (pao_id,inst_id,MONTHS,YEARS,yearmonths,salaries,wages,over_time_allawance,medical_treatment,travel_expense_domestic,"
