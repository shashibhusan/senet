...
String sql = "select * from eis_basicinfo a join eis_postinginfo b on a.email=b.email where a.name LIKE '%"+name+"%'";
...
buffer=buffer+"<a href='searchFinal.jsp?nMhds495ds6fhXxQjd="+resultSet.getString("a.token")+"'>"+resultSet.getString("a.name").toUpperCase()+"</a></td><td id='data-ret'>"+resultSet.getString("a.email")+"</td>";
...
buffer=buffer+"<td id='data-ret'>"+resultSet.getString("b.state")+"</td>";
...
buffer=buffer+"<a href='searchFinal.jsp?nMhds495ds6fhXxQjd="+resultSet.getString("a.token")+"'>"+resultSet.getString("a.name").toUpperCase()+"</a></td><td id='data'>"+resultSet.getString("a.email")+"</td>";
