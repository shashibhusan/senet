...
System.out.println("search parameter //" +name+"//"+disci+"//"+inst );
...
connection = ConnectionManager.getConnectionDirectForMySQL();
statement=connection.createStatement();
String sql = "select * from eis_basicinfo a join eis_postinginfo b on a.email=b.email where a.name LIKE '%"+name+"%' and a.bas_descipline='"+disci+"' and b.state='"+inst+"'";
