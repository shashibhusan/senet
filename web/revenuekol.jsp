...
String strCumulative=" SELECT sum(Common_total),sum(sale_total),sum(sdp_total),sum(edp_total),sum(mdp_total),sum(Seminar_total),sum(Capacity_total),sum(Project_total),sum(Sick_total),sum(Inplant_total),sum(NSIC_total),sum(Energy_total),sum(Surveys_total),sum(sale_publication_total),sum(Information_total),sum(others_total),sum(Accounts_total) FROM tbl_revenue where user_date >= '"+tYears+"-01-01' and user_date <='"+tYears+"-"+months+"-30' and instid='"+instId+"'";
...
<form  name="form1" id="form1" method="post" action=" revenuekol_save.jsp">
...
<table width="100%" border="0" align="center" >
  <tr>
    ...
    <td width="68" class="tableheader">MSMEDI-Kolkata</td>
    <td width="85" class="tableheader">Br.MSMEDI Durgapur </td>
    <td width="85" class="tableheader">Br.MSMEDI Siliguri </td>
    <td width="85" class="tableheader">Br.MSMEDI Suri </td>
    <td width="85" class="tableheader">Br.MSMEDI Port Blair </td>
  </tr>
   <%if(divFlag==0){%>
  <tr>
...
<td class="tablecontent2"><input type="text"  value="0" name="b_2" id="b_2"size="7" /></td>
  ...
  <td class="tablecontent2"><input type="text"  value="0" name="d_2" id="d_2"size="7" /></td>
 <td class="tablecontent2"><input type="text"  value="0" name="e_2" id="e_2"size="7" /></td>  
  </tr>
  <tr>
 ...
 <td class="tablecontent2"><input type="text"  value="0" name="d_4" id="d_4"size="7" /></td>
  <td class="tablecontent2"><input type="text"  value="0" name="e_4" id="e_4"size="7" /></td>  
  </tr>
  <tr>
 ...
 <td class="tablecontent2"><input type="text"  value="0" name="d_6" id="d_6"size="7" /></td>
 <td class="tablecontent2"><input type="text"  value="0" name="e_6" id="e_6"size="7" /></td>  
  </tr>
  <tr>
 ...
 <td class="tablecontent2"><input type="text"  value="0" name="d_8" id="d_8"size="7" /></td>
  <td class="tablecontent2"><input type="text"  value="0" name="e_8" id="e_8"size="7" /></td>  
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td class="tablecontent2"><input type="text"  value="0" name="a_10" id="a_10"size="7" /></td>
 <td class="tablecontent2"><input type="text"  value="0" name="b_10" id="b_10"size="7" /></td>
  <td class="tablecontent2"><input type="text"  value="0" name="c_10" id="c_10"size="7" /></td>
 <td class="tablecontent2"><input type="text"  value="0" name="d_10" id="d_10"size="7" /></td>
<td class="tablecontent2"><input type="text"  value="0" name="e_10" id="e_10"size="7" /></td>  
  </tr>
  <tr>
  ...
  <input type="hidden" size="5" name="h_12" value="Energy Audits" />
    ...
    <td class="tablecontent2"><input type="text"  value="0" name="a_12" id="a_12"size="7" /></td>
  <td class="tablecontent2"><input type="text"  value="0" name="b_12" id="b_12"size="7" /></td>
  <td class="tablecontent2"><input type="text"  value="0" name="c_12" id="c_12"size="7" /></td>
  <td class="tablecontent2"><input type="text"  value="0" name="d_12" id="d_12"size="7" /></td>
  <td class="tablecontent2"><input type="text"  value="0" name="e_12" id="e_12"size="7" /></td>  
  </tr>
  <tr>
  ...
  <tr>
   ...
   <input type="hidden" size="5" name="h_14" value="PD Accounts" />
    <td class="tablecontent12"><span class="pink">PD Accounts</span></td>
     ...
     <td class="tablecontent2"><input type="text"  value="0" name="a_14" id="a_14"size="7" /></td>
  <td class="tablecontent2"><input type="text"  value="0" name="b_14" id="b_14"size="7" /></td>
  <td class="tablecontent2"><input type="text"  value="0" name="c_14" id="c_14"size="7" /></td>
  <td class="tablecontent2"><input type="text"  value="0" name="d_14" id="d_14"size="7" /></td>
  <td class="tablecontent2"><input type="text"  value="0" name="e_14" id="e_14"size="7" /></td>  
  </tr>
  <tr>
