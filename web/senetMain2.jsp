...
<FORM name="frmMain"  method="post" action="senetAchievment_branch.jsp" >
...
&nbsp;</td>
  <td width="261">
      <select name="cmbMonth1" id="cmbMonth" style="width: 220px">
  ...
  <td>
      &nbsp;&nbsp;Year
      &nbsp;&nbsp;&nbsp;</td><td>
      <select name="cmbYear1" id="cmbYear" style="width: 220px">
