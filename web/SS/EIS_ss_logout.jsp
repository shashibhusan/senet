...
<META HTTP-EQUIV="REFRESH" CONTENT="15;URL=ss_login.jsp">
  <title>EIS - Logout</title>
  <link rel="shortcut icon" href="fevicon.png" type="image/x-icon">
  <script>
function go() {
window.location.replace("/mprsenet/ss_login.jsp",'window','toolbar=1,location=1,directories=1,status=1,menubar=1,scrollbars=1,resizable=1');
self.close()
}
</script>
</head>
