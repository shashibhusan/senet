...
try{
	...
	String ACHIV_REPORT_MONTH=request.getParameter("h_1");
	System.out.println(ACHIV_REPORT_MONTH);
...
for (int i=1;i<=17;i++){
j= k;
String sqlPart1 = "INSERT INTO  tbl_revenue_branch(instId, months,user_date, years, msmedi,name, branch1) values('"+instId+"', '"+months+"','"+user_date+"', "+years+", "+request.getParameter("a_"+i)+",'"+request.getParameter("h_"+i)+"', "+request.getParameter("b_"+i)+") ";
...
String strQueryRow3 = ",msmedi ="+request.getParameter("a_"+i)+",branch1 ="+request.getParameter("b_"+i);
