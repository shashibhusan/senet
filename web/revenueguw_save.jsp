...
for (int i=1;i<=17;i++){
j= k;
String sqlPart1 = "INSERT INTO  tbl_revenue_branch(instId, months, years, msmedi, branch1, branch2, branch3, branch4, branch5,name, branch6) values('"+instId+"', '"+months+"', "+years+", "+request.getParameter("a_"+i)+", "+request.getParameter("b_"+i)+", "+request.getParameter("c_"+i)+", "+request.getParameter("d_"+i)+", "+request.getParameter("e_"+i)+", "+request.getParameter("f_"+i)+",'"+request.getParameter("h_"+i)+"', "+request.getParameter("g_"+i)+") ";
...
String strQueryRow3 = ",msmedi ="+request.getParameter("a_"+i)+" ,branch1 ="+request.getParameter("b_"+i)+",branch2 ="+request.getParameter("c_"+i)+",branch3 ="+request.getParameter("d_"+i)+",branch4 ="+request.getParameter("e_"+i)+",branch5 ="+request.getParameter("f_"+i)+",branch6 ="+request.getParameter("g_"+i);String strQueryRow4=" WHERE instId = '"+instId+"'AND name ='"+request.getParameter("h_"+i)+"' and months='"+months+"' AND years="+years ;
