<%-- 
    Document   : EIS_success
    Created on : Dec 29, 2017, 9:55:23 PM
    Author     : Admin
--%>
     ...
     <body>
       ...
       <div style="font-size:14px;font-family:Verdana;font-weight:bold; background:  #64bb64; padding-top: 5px; padding-bottom: 5px; " align="center" ><font color="#990000">ALL INDIA MSME-DO EMPLOYEES' INFORMATION SYSTEM </font>
         ...
         <div align="center" title="Reciept" class="box">
             <h5 align="right"><a HREF="EIS_logout.jsp" > <strong>Logout</strong></a></h5>
...
<tr>
        <td class="success">
           Hello <%=name1%> !
            ...
            <tr>
                <td class="success"><br/> Your data saved as draft successfully. </td>
            </tr>
        ...
        <script>
            function myFunction(){
                 document.forms[0].action = "EIS_forms.jsp"
                 return true;
            }
        </script>
        <%
...
<script>
              function fail(){
                 document.forms[0].action = "EIS_logout.jsp"
                 return true;
            }
        </script>
...
String sql10="delete  from eis_trainingcompleted where email='"+email+"' and trainingName='' or tcFrom='' or tcTo=''";
int rs10=st.executeUpdate(sql10);


if(rs1>0 && rs5>0 && rs6>0 && rs9>0){
