...
//	if (designation.matches("[a-zA-Z_0-9]")) {
...
%>
 <h3><center><FONT color="#800000"> CURRENT STATUS OF ACR OF IA in O/O DCMSME  </font></center></h3><br>	<script type="text/javascript">
