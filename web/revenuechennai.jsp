...
<table width="100%" border="0" align="center">
  <tr>
    ...
    <td width="68" class="tableheader">MSMEDI-Chennai</td>
    <td width="85" class="tableheader">Br.MSMEDI CoimBatore </td>
    <td width="85" class="tableheader">Br.MSMEDI Tuticorin </td>
  </tr>
   <%if(divFlag==0){%>
  <tr>
 ...
 <td class="tablecontent2"><input type="text"  value="0" name="b_16" id="b_16"size="7" /></td>
  <td class="tablecontent2"><input type="text"  value="0" name="c_16" id="c_16"size="7" /></td>
  </tr>
  <tr>
