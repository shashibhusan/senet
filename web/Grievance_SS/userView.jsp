...
function submitReply()
{
    ...
    {
        document.forms[0].action = "reply_by_user.jsp"
  return true;
    }
   ...
   <form id="divPrint" name="myForm" action="" method="POST" enctype="multipart/form-data">
            ...
            <table align="center" width="1050px"  id="mainTable1">
                <tr>
                    ...
                    <td align="right" style="font-family: Bookman Old Style; font-weight: 10px; color: #9e0bc2 "><a HREF="logout.jsp" >Logout</a></td>
                                ...
                                <table width="40%" align="center">
                                    <tr>
                                       ...
                                       if((rs.getString("replyType")).equals("user")){space="";}else{space="("+rs.getString("replyType")+")";}
                                        ...
                                        <td class="daata" width="250px" align="left"><a href="download.jsp?f=<%=rs.getString("file")%>">&nbsp;&nbsp;&nbsp;View Document</a></td>
