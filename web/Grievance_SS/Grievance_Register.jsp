...
function saveEis()
{
 ...
 /*   var upload=document.myForm.upload.value;
    if(upload==null || upload=="")
      ...
      {
  document.forms[0].action = "grievance_submit.jsp?v="+grType+"&vl="+grDetail;
  return true;
      }
      }
        ...
        <tr>
            <td>
                <div class="hide" style="font-size: 14px; font-family: Verdana; font-weight: bold;
                    ...
                    <font color="#990000"></font>O/o DC-MSME
                </div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td >
                ...
                <div style="float: right">
                    <b align="right"><a HREF="logout.jsp" > <strong>Logout</strong></a></b>
                </div>
            </td>
        </tr>
        <%
