...
{
if(document.frmMain.cmbIns.value!="" && document.frmMain.cmbMonth.value!="" && document.frmMain.cmbYear.value!="" && document.frmMain.mnm.value!="") {
	document.frmMain.action="pmsreport.jsp";
      } else {
			alert('Please selected the Criteria.......');
            document.frmMain.cmbIns.focus();
            return false;
...
<FORM name="frmMain"  method="post" action="pmsreport.jsp" > 
...
<br>
<h3 align="center" ><font  color="#000099">Monthly Progress Report Of progress Monitoring System</font></h3>
