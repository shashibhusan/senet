...
for (int i=1;i<=17;i++){
j= k;
String sqlPart1 = "INSERT INTO  tbl_revenue_branch(instId, months,user_date, years, msmedi, branch1,name,branch2) values('"+instId+"', '"+months+"','"+user_date+"', "+years+", "+request.getParameter("a_"+i)+", "+request.getParameter("b_"+i)+" ,'"+request.getParameter("h_"+i)+"' , "+request.getParameter("c_"+i)+") ";
...
String strQueryRow3 = ",msmedi ="+request.getParameter("a_"+i)+" ,branch1 ="+request.getParameter("b_"+i)+",branch2 ="+request.getParameter("c_"+i);
