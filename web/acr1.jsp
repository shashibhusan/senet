...
<h3 align="center" > <span id="ctl00_ContentPlaceHolder1_lbl_topic" style="color: rgb(204, 0, 0); font-family: Microsoft Sans Serif; font-size: medium; font-weight: bold; text-decoration: underline; text-align: center;">ACR Availability Entry Form Of An Employee</span></h3>
	...
	<input type="hidden" size="5" name="mnm" value="ffff" />

	<table width="900"  border="0" align="center" cellpadding="0" cellspacing="0" BORDERCOLOR="#918002525" style="border-collapse: collapse" >
  <tr>
...
<option value='Senior Hindi Translator'>Senior Hindi Translator</option>
<option value='Junior Hindi Translator'>Junior Hindi Translator</option>
<option value='Draught man'>Draught man</option>
