...
<table width="100%" border="0">
  <tr>
    ...
    <td width="68" class="tableheader">MSMEDI-Agartala</td>
    <td width="85" class="tableheader">Br.MSMEDI Aizwal </td>
  ...
  <tr>
    ...
    <td class="tablecontent11"><span>Common facility workshop revenue </span></td>
  ...
  <tr>
    ...
    <td class="tablecontent12"><span>sale of trainee products</span></td>
 ...
 <td class="tablecontent2"><input type="text"  value="0"name="b_12" id="b_12"size="7" /></td>
  ...
  <tr>
    ...
    <td class="tablecontent12"><span class="pink">Information Technology Royalty</span></td>
 	<td class="tablecontent2"><input type="text"  value="0"name="a_16" id="a_16"size="7" /></td>
  <td class="tablecontent2"><input type="text"  value="0"name="b_16" id="b_16"size="7" /></td>
