...
<br>
<br><br><br><table width="60%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tbody><tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="alert_table">
      <tbody><tr>
        <td width="10%">&nbsp;</td>
		<td class="alert_text">LOGOUT</td>
		</tr>
		<tr>
			<td colspan="2" class="alert_header" bgcolor="#990000">Suggestions:</td>
		</tr>
		<tr>
			<td colspan="2">
			<form name="erroralert">
				<ul>
					<br><li>
					  <p>Your  session is closed Due to Logout, If You want to view Entry form &amp; Report <br>
					    <br>
					  </p>
					</li>
					<li>Please <a href="slogin.jsp">Click Here</a> to login.</li>
				</ul>
				</form>
			</td>
		</tr>
