...
<div class="menu_div" >
        ...
        <li id="active"><a href="main.jsp" target="_top">Home</a></li>
         <li id="active">
             <font color="white" ><strong>Entry Section</strong></font> </li>
        <li>
		  ...
		  <font color="#EF2100"> Change password</font></a>
                                ...
                                <li>
				<a href="#" onMouseOver="window.status=''; return true;" onClick="linkopen('expenditure/expenditureba.jsp?mnm=<%=Crosssite%>')">
		   <font color="#EF2100">B&A fund allocation </font></a>
				</li>
                   <li>
				<a href="#" onMouseOver="window.status=''; return true;" onClick="linkopen('expenditure/BeAndRe.jsp?mnm=<%=Crosssite%>')">
		   <font color="#EF2100">BE & RE estimate </font></a>
				</li>
                                <li>
				<a href="#" onMouseOver="window.status=''; return true;" onClick="linkopen('expenditure/allocationreport.jsp?mnm=<%=Crosssite%>')">
		   <font color="#EF2100">allocation report</font></a>
				</li>
                   
                   <li>
                    <a href="#" onMouseOver="window.status=''; return true;" onClick="linkopen('expenditure/expenditurebaEntry.jsp?mnm=<%=Crosssite%>')">
                        <font color="#EF2100">B&A expenditure entry</font></a>
                </li>
                   <li>
                    <a href="#" onMouseOver="window.status=''; return true;" onClick="linkopen('expenditure/expenditurebaReport.jsp?mnm=<%=Crosssite%>')">
                        <font color="#EF2100">B&A expenditure report</font></a>
                </li>
                   <%-- Raghavendra 


                  <li class = "green"> <a href="#" onMouseOver="window.status=''; return true;" onClick="linkopen('revalidation_main.jsp?mnm=<%=Crosssite%>'),showdate()">
		<font color="#EF2100"> Senet Re-validation Amount</font> </a></li>
		...
		<font color="#EF2100"> SENET Amount Sanctioned</font> </a></li>
		  ...
		  <font color="#EF2100"> LIB. Exp. Entry Form</font></a></li>
                   ...
                   <li class = "green"> <a href="#" onMouseOver="window.status=''; return true;" onClick="linkopen('UploadSanctionAmountMain.jsp?mnm=<%=Crosssite%>'),abc()">
		<font color="#EF2100"> Upload Sanction Amount</font> </a></li>
<%--
		...
		<font color="#EF2100"> ISO Amount Sanctioned</font> </a></li>
		  ...
		  <font color="#EF2100">ISO 9000/14001/HACCP</font></a></li>
                  ...
                  <li > <a href="#" onMouseOver="window.status=''; return true;"  onclick="linkopen('100-days/plan1.jsp?mnm=<%=Crosssite%>')">
		  <font color="#EF2100"> 100 Days Program </font></a></li>
                 --%>  
...
<div class="menu_div" >
        <ul>
       <li id="active"><a href="main.jsp" target="_top">Home</a></li>
       <li id="active"><font color="WHITE"><strong>Senet Report</strong></font></li>
        <li>
				...
				<font color="#EF2100">Sanctioned Amount (SENET)</font></a>
                                        </li>
                                ...
                                <li>
				<a href="#" onMouseOver="window.status=''; return true;" onClick="linkopen('revalidation_main.jsp?mnm=<%=Crosssite%>'),abc()">
				<font color="#EF2100">Senet Re-validation Amount</font></a>
                                        </li>

                                <%--Raghav Ends --%>
					<li>
				<a href="#" onMouseOver="window.status=''; return true;" onClick="linkopen('senetMain1.jsp?mnm=<%=Crosssite%>'),abc()">
				<font color="#EF2100">Exp. incurred (SENET)</font></a>				</li>
                                
<%-- Monthly Report by Raghav --%>            
                                <li>
				<a href="#" onMouseOver="window.status=''; return true;" onClick="linkopen('monthlyreport.jsp?mnm=<%=Crosssite%>'),abc()">
				<font color="#EF2100">Uploaded Report (SENET)</font></a>				</li>
<%-- Ends --%>                              
                                 <li>
				<a href="#" onMouseOver="window.status=''; return true;" onClick="linkopen('senetMain2.jsp?mnm=<%=Crosssite%>'),abc()">
				<font color="#EF2100">Branch-wise Exp. (SENET)</font></a>				</li>
                                <li>
            ...
            <%--                    
				...
				<a href="#" onMouseOver="window.status=''; return true;" onClick="linkopen('ISOReport.jsp?mnm=<%=Crosssite%>'),abc()">
                                    <font color="#EF2100">ISO Report</font></a></li>
		  ...
		  <font color="#EF2100"> 100 Days Program </font></a></li>
			...
			<%-- start commented by shashi bhusan patel(19may2015) to seprate the court case application and ACR application from the SENET application--%>
				...
				<%--<li id="active"><font color="WHITE">Court Cases Report</FONT></li>
		...
		<font color="#EF2100"> Courtwise Details</font></a>  </li>--%>
		 ...
		 <%--<li> <a href="#" onMouseOver="window.status=''; return true;" onclick="linkopen('rtmain1courtwise.jsp?mnm=<%=Crosssite%>')">
        ...
        <li>
         ...
         <%--         
		  ...
		  <font color="#EF2100">ISO 9000/14001/HACCP</font></a></li>   --%>
                  ...
                  <%--  Raghav starts for create menu for EIS --%>

           <%--       <li> <a href="#" onMouseOver="window.status=''; return true;"  onclick="linkopen('main_EIS.jsp?mnm=<%=Crosssite%>')">
		  <font color="#EF2100">Employee Info. System</font></a></li>    
                  <script>
                      function myFunction1() {
    window.open("EIS_01.jsp?mnm=<%=Crosssite%>");
}
                  </script>

                  <li>
                    <a href="#" onMouseOver="window.status=''; return true;"  onclick="myFunction1()">
		  <font color="#EF2100">Employee Info. System</font></a>
                  </li>
