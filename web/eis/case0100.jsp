...
String sql = "select * from eis_postinginfo where curr_despln='"+desig+"'";
...
statement=connection.createStatement();
int iCount=0;
String sql = "select * from eis_basicinfo a join eis_postinginfo b on a.email=b.email where b.curr_despln='"+desig+"'";
System.out.println("++++++++++"+sql);
resultSet = statement.executeQuery(sql);
String buffer1="<table class='sortable'>"
        + "<thead id='data_head'>"
        + "<td align='center' >S.No. <a href='#'><img align='right' src='eis_image/filter_sort_788142.png' height='10' width='10'/></a></td>"
        + "<td align='center'>Name</td>"
        + "<td align='center'>Email</td>"
        + "<td align='center'>Designation</td>"
        + "<td align='center'>Discipline</td>"
        + "<td align='center'>Current Office</td>"
        + "<td align='center'>Retired</td>" +
        "</thead>";
//  <td align='center'>Current Office Duration</td>
