...
String inst=request.getParameter("val3");
...
connection = ConnectionManager.getConnectionDirectForMySQL();
statement=connection.createStatement();
String sql = "select * from eis_basicinfo a join eis_postinginfo b on a.email=b.email where a.name LIKE '%"+name+"%' and b.curr_despln='"+desig+"' and a.bas_descipline='"+disci+"' and b.state='"+inst+"'";
