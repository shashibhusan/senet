...
String sql = "select * from eis_basicinfo a join eis_postinginfo b on a.email=b.email and b.curr_despln='"+desig+"' and a.bas_descipline='"+disci+"'";
...
statement=connection.createStatement();
int iCount=0;
String sql = "select * from eis_basicinfo a join eis_postinginfo b on a.email=b.email and b.curr_despln='"+desig+"' where a.bas_descipline='"+disci+"'";
