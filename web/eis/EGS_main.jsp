<%-- 
    Document   : EGS_main
    Created on : Apr 2, 2018, 11:43:35 AM
    Author     : Senet
--%>
...
function saveEis()
{
 ...
 /*   var upload=document.myForm.upload.value;
    if(upload==null || upload=="")
      ...
      {
  document.forms[0].action = "EGS_view.jsp?val="+grType+"&val1="+grDetail;
  return true;
      }
      }
...
System.out.println("token generated=="+Session);
        ...
        try{
            ...
            String query="select * from egs_logindata where email='"+email+"'";
        ...
        <tr>
            <td>
                <div class="hide" style="font-size: 14px; font-family: Verdana; font-weight: bold;
                    ...
                    <font color="#990000">ALL INDIA MSME-DO EMPLOYEES GRIEVANCE SYSTEM </font>
                </div>
                <br />
                <br />
            </td>
        ...
        <tr>
            <td >
                ...
                <div style="float: right">
                    <b align="right"><a HREF="EGS_logout.jsp" > <strong>Logout</strong></a></b>
                </div>
            </td>
        </tr>
        <%
                    ...
                    <fieldset>
                        ...
                        <table align="center" width="100%">
                            <tr>
                                <td width="50%">
                                    <div>
                                        ...
                                        <div align="left" id="element">
                                            ...
                                            <input type="text" id="bas_designation" name="bas_designation" value="<%=rs.getString("bas_designation")%>">
                                        </div>
                                        <div align="left" id="element">
                                ...
                                <div>
                                    <div  align="left" id="element">
                                        <b id="ele_head">Discipline :</b><br />
                                        <input type="text" id="discipline" name="discipline"  value="<%=rs.getString("bas_descipline")%>" />
                                    </div>
                                    <div align="left" id="element">
                                        <b id="ele_head">Current Posting :</b><br />
                                        <input type="text" id="cur_posting" name="cur_posting"  value="<%=rs.getString("state")%>" />
                                    </div>
                                    <div align="left" id="element">
                                        <b id="ele_head">Date of Joining (Current office)</b><br />
                                        <input type="text" id="doj" name="doj"  value="<%=rs.getString("curr_doj")%>" />
                                    </div>
                                    </div>
                                </td>
                            </tr>
...
<div id="errDec"></div>
    ...
    <table width="500px" align="center" >
        ...
        <%
            ...
            {
        %>
<jsp:forward page="EGS_userView.jsp" />
