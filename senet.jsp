...
<table width="79%" border="0" align="center"  >
  <tr>
    ...
    <td colspan="2"  align="center" class="tableheader"><div align="center">Amount Sanctioned </div>
  ...
  <tr>
    ...
    <td colspan="2"  class="tablecontent2" ><div align="center">
      <input type="text" name="web" id="web" size="15" value='<%=fix_val2%>'readonly="2"/>
    </div></td>
    <td  class="tablecontent2" ><div align="center">
  ...
  <%  if(instId.equals("I10"))
	{%>
  <tr>
    <td width="176" rowspan="2"  class="tableheader"><div align="center"><strong>Subject</strong></div></td>
    <td colspan="3"  class="tableheader"><div align="center"></div></td>
  </tr>
  <tr>
  ...
  <tr>
  <td  class="tablecontent11"><strong><div align="center">Hardware/Software</div> </strong></td>
 ...
 <td  class="tablecontent11"><div align="center"><input type="text" size="15" name="br_hardware_upto" id="br_hardware_upto" /> </div></td>
  ...
  <tr>
    <td  class="tablecontent11"><div align="center"><strong>Internet Connectivity </strong></div></td>
 ...
 <td  class="tablecontent11"> <div align="center"> <input type="text" size="15" name="br_hardware_target_5" id="br_hardware_target_5"> </div></td>
  ...
  <tr>
    <td  class="tablecontent11"><div align="center">
      <input type="text" name="branch" id ="branch" value="Varanasi" />
    </div></td>
    <td  class="tablecontent11"><div align="center">
    ...
    <td  class="tablecontent11"><div align="center">
      <input type="text" size="15" name="br_con_target"  id="br_con_target" />
    </div></td>
    <td  class="tablecontent11"><div align="center">
      <input type="text" size="15" name="br_con_tomonth" id="br_con_tomonth" />
    </div></td>
    <td  class="tablecontent11"><div align="center">
      <input type="text" size="15" id="br_con_upto" name="br_con_upto" />
    </div></td>
  </tr>
  <% } else %>
  <%  if(instId.equals("I3"))
  ...
  <tr>
    ...
    <td  class="tablecontent11"><div align="center">
      <input type="text" size="15" name="br_con_target_1"  id="br_con_target_1" />
    </div></td>
    <td  class="tablecontent11"><div align="center">
      <input type="text" size="15" name="br_con_tomonth_1"id="br_con_tomonth_1" />
    </div></td>
    <td  class="tablecontent11"><div align="center">
      <input type="text" size="15" name="br_con_upto_1" id="br_con_upto_1" />
    </div></td>
  </tr>
  <% } else %>
  <%  if(instId.equals("I8"))
  ...
  <tr>
    ...
    <td  class="tablecontent11"><div align="center">
      <input type="text" size="15" name="br_con_tomonth_2" id="br_con_tomonth_2" />
    </div></td>
    <td  class="tablecontent11"><div align="center">
      <input type="text" size="15" name="br_con_upto_2"id="br_con_upto_2" />
    </div></td>
    /tr> </tr>
  <tr>
    <td  class="tablecontent11"><div align="center">
    ...
    <td  class="tablecontent11"><div align="center">
      <input type="text" size="15" name="br_con_target_3" id="br_con_target_3" />
    </div></td>
    <td  class="tablecontent11"><div align="center">
      <input type="text" size="15" name="br_con_tomonth_3" id="br_con_tomonth_3" />
    </div></td>
    <td  class="tablecontent11"><div align="center">
      <input type="text" size="15" name="br_con_upto_3" id="br_con_upto_3" />
    </div></td>
  </tr>
  <% } else  %>
  <%  if(instId.equals("I9"))
...
%>
  <tr>
    <td  class="tablecontent11"><div align="center">
      <input type="text" name="branch_<%=icnt%>" id="branch_<%=icnt%>"  value='<%=rsAdminResult1.getString("Branch")%>' />
    </div></td>
    <td  class="tablecontent11"><div align="center">
      <input type="text" size="15" name="br_hardware_target_<%=icnt%>" id="br_hardware_target_<%=icnt%>" value='<%=rsAdminResult1.getString("Br_hardware_target")%>' />
    </div></td>
    <td  class="tablecontent11"><div align="center">
      <input type="text" size="15" name="br_hardware_tomonth_<%=icnt%>" id ="br_hardware_tomonth_<%=icnt%>" value='<%=rsAdminResult1.getString("Br_hardware_tomonth")%>' />
    </div></td>
    <td  class="tablecontent11"><div align="center">
      <input type="text" size="15" name="br_hardware_upto_<%=icnt%>" id="br_hardware_upto_<%=icnt%>" value='<%=rsAdminResult1.getString("Br_hardware_upto")%>' />
    </div></td>
    <td  class="tablecontent11"><div align="center">
      <input type="text" size="15" name="br_hardware_upto_<%=icnt%>"  id="br_hardware_upto_<%=icnt%>" value='<%=rsAdminResult1.getString("Br_con_target")%>' />
    </div></td>
    <td  class="tablecontent11"><div align="center">
      <input type="text" size="15" name="br_con_tomonth_<%=icnt%>"id="br_con_tomonth_<%=icnt%>" value='<%=rsAdminResult1.getString("Br_con_tomonth")%>' />
    </div></td>
    <td  class="tablecontent11"><div align="center">
      <input type="text" size="15" name="br_con_upto_<%=icnt%>" id="br_con_upto_<%=icnt%>" value='<%=rsAdminResult1.getString("Br_con_upto")%>' />
    </div></td>
  </tr>
  <% }%>
  <% }%>
