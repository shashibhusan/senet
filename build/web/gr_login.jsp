<%-- 
    Document   : gr_login
    Created on : Apr 2, 2018, 12:50:13 PM
    Author     : Senet
--%>
...
#reee{
    margin-top: 5px;
        ...
        <script>
          ...
          // alert("Not a valid e-mail address");
           document.getElementById("errEmail").innerHTML="*Please enter valid e-mail address."
           return false;
           }
            if (pass=="" || pass==null){
               ...
               {
           document.forms[0].action = "EGS_login_check.jsp"
           return true;
               }
           }
    ...
    <body background=" #ecf0f3 ">
       ...
       <div style="font-size:14px;font-family:Verdana;font-weight:bold; background:  #64bb64; padding-top: 5px; padding-bottom: 5px; " align="center" ><font color="#990000">ALL INDIA MSME-DO EMPLOYEE'S Grievance SYSTEM </font>
         </div>
       <br/>
         ...
         <table  align="center" border="0px;">
             <tr>
                 <td align="center">
                   <strong style=" font-size: 20px; font-weight: 100;  font-family:sans-serif;"><b>EGS Login</b></strong>
                 </td>
             </tr>
             <tr>
                 <td>&nbsp;</td>
...
<div for="lname" align="left" class="data">Captcha :<br/></div>
    ...
    <input type="text" id="reee" class="captcha" name="answer" align="center" required/><br>
