<%-- 
    Document   : updateotherinfo
    Created on : 10 Mar, 2021, 5:23:56 PM
    Author     : msme
--%>
            ...
            <form name="updateOtherdetailEis" class="updateOtherdetailEis" id="updateOtherdetailEis" action="InsertOtherDetails.jsp" method="POST" autocomplete="off">
                <table id="MyTable" align="center">
                    ...
                    <tr   bgcolor=" #f9f9f9 ">
                        ...
                        <td class="data lst"><input type="text" class="inptbox" name="employee_name" id="employee_name" value="<%=emp_desig%>" index="1" readonly="2" disabled="2"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr  bgcolor=" #f9f9f9 ">
                        ...
                        <td class="data lst"><input type="text" class="inptbox" name="employee_name" id="employee_name" value="<%=emp_cur_ofc%>" index="1" readonly="2" disabled="2"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="data lst">
                            ...
                            <span id="seldateDivHomtown">
                                ...
                                <div>
                                    <input type="text" name="DateFromHmt" class="datepicker" id="DateFromHmt" placeholder="date from"/><br/>
                                    <input type="text" name="DateToHmt" class="datepicker" id="DateToHmt" placeholder="till date" readonly="2" />
                                </div>
                            </span>
                        </td>
                    </tr>
                    <tr bgcolor=" #f9f9f9 ">
                        ...
                        <td class="data lst">
                            ...
                            <span id="seldateDivNorthEast">
                                ...
                                <div style="float: ">
                                    <input type="text" name="DateFromNER" class="datepicker" id="DateFromNER" placeholder="date from" /><br/>
                                    <input type="text" name="DateToNER" class="datepicker" id="DateToNER" placeholder="till date" readonly="2" />
                                </div>
                            </span>
                        </td>
                    </tr>
            ...
            <%} else {
                ...
                <table id="MyTable" align="center">
                    ...
                    <tr   bgcolor=" #f9f9f9 ">
                        ...
                        <td class="data1 lst"><%=emp_desig%></td>
                    </tr>
                    <tr>
                    ...
                    <tr  bgcolor=" #f9f9f9 ">
                        ...
                        <td class="data1 lst"><%=emp_cur_ofc%></td>
                    </tr>
                    <tr>
