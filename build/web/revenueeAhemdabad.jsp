...
<table width="100%" border="0" align="center" >
  ...
  <tr>
    ...
    <td width="68" class="tableheader">MSMEDI-Ahmedabad</td>
    <td width="85" class="tableheader">Br.MSMEDI Rajkot</td>
    <td width="85" class="tableheader">Br.MSMEDI Silvassa </td>
  </tr>
   <%if(divFlag==0){%>
  <tr>
  ...
  <tr>
    ...
    <td class="tablecontent12"><span class="pink">sale of trainee products</span></td>
  	 ...
  	 <td class="tablecontent12"><input type="text"  value="0" name="a_2" id="a_2"size="7" /></td>
  <td class="tablecontent12"><input type="text"  value="0" name="b_2" id="b_2"size="7" /></td>
  <td class="tablecontent12"><input type="text"  value="0" name="c_2" id="c_2"size="7" /></td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <input type="hidden" size="5" name="h_4" value="EDP training fee" />
    <td class="tablecontent12"><span class="pink">EDP training fee</span></td>
   	 ...
   	 <td class="tablecontent12"><input type="text"  value="0" name="a_4" id="a_4"size="7" /></td>
  <td class="tablecontent12"><input type="text"  value="0" name="b_4" id="b_4"size="7" /></td>
  <td class="tablecontent12"><input type="text"  value="0" name="c_4" id="c_4"size="7" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="tablecontent12"><span class="pink">Seminar fees</span></td>
   	 ...
   	 <td class="tablecontent12"><input type="text"  value="0" name="a_6" id="a_6"size="7" /></td>
  <td class="tablecontent12"><input type="text"  value="0" name="b_6" id="b_6"size="7" /></td>
  <td class="tablecontent12"><input type="text"  value="0" name="c_6" id="c_6"size="7" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="tablecontent12"><span class="pink">Project appraisals</span></td>
    	 ...
    	 <td class="tablecontent12"><input type="text"  value="0" name="a_8" id="a_8"size="7" /></td>
  <td class="tablecontent12"><input type="text"  value="0" name="b_8" id="b_8"size="7" /></td>
  <td class="tablecontent12"><input type="text"  value="0" name="c_8" id="c_8"size="7" /></td>
  </tr>
  <tr>
