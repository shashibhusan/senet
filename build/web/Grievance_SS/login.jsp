...
<br/>
 ...
 <div for="lname" align="left" class="data">Enter Captcha :<br/>
     <img id="captcha" style=" margin-left: 70px" src="<c:url value="reCaptch.jsp" />" width="150"><a href="JavaScript:refresh()"><img src="refresh.png" style="border:none" width="20" height="25"/></a> <br>
 <input type="text" class="captcha" name="answer" align="right" /><br></div>
    ...
    <br/><br>
    <h4 align="center">Not registered yet! <a href="registration.jsp"> Register.</a></h4>
  </form>
<br/><br/>
