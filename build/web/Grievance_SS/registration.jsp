...
*/
    ...
    <body bgcolor=" #d1d1d1 ">
      ...
      <div style="width:510px; margin:0 auto; color: green; font-family: Bookman Old Style; padding-bottom: 15px; " id="msg"></div>
       <div style="width:750px; margin:0 auto; height: 100%; overflow: auto;">
      <form id="ssForm">
...
<div align="left" id="notice1" style=" font-family: vardana; font-size: 15px; margin-left: 75px;"><a style=" color: red">*</a> Already registered,<a href="login.jsp"> login here.</a></div><br/>
