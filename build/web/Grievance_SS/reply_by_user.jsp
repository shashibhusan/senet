...
String fileUploadPath="/home/mpr_dcmsme/docs/dcmsme/mprsenet/Grievance_files_ss/";
...
String connectionUrl = "jdbc:mysql://10.25.140.121:3306/";
String dbName = "mpr_dcmsme";
String userId = "mpr_dcmsme";
                ...
                <td>
                    <table width="450px;" id="msg" align="center">
                        <tr>
                            ...
                            <td align="center"><a href="userView.jsp">Home </a></td>
