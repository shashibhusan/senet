...
System.out.println("search parameter //" +name+"//"+desig+"//"+inst );
...
connection = ConnectionManager.getConnectionDirectForMySQL();
statement=connection.createStatement();
String sql = "select * from eis_basicinfo a join eis_postinginfo b on a.email=b.email where a.name LIKE '%"+name+"%' and b.curr_despln='"+desig+"' and b.state='"+inst+"'";
