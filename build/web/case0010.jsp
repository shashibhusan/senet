...
String sql = "select * from eis_basicinfo where bas_descipline='"+disci+"'";
...
statement=connection.createStatement();
int iCount=0;
String sql = "select * from eis_basicinfo a join eis_postinginfo b on a.email=b.email where a.bas_descipline='"+disci+"'";
