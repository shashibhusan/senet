       ...
       <li id="active"><a href="main.jsp" target="_top">Home</a></li>
        <li>
		  ...
		  <font color="#EF2100"> Senet Exp. Entry Form</font></a></li>
           ...
           <%-- Raghavendra  
            <li> <a href="#" onMouseOver="window.status=''; return true;"  onclick="linkopen('SenetPerformance.jsp?mnm=<%=Crosssite%>')">
		  <font color="#EF2100"> Submit Performance Report</font></a></li>
           <%-- End Raghavendra  --%>
