...
function formValidator(){
	...
	if (!document.getElementById('amc_of_pc1').value.match(numericExpression))
	  ...
	  if (!document.getElementById('connectivity1').value.match(numericExpression))
      {
	  ...
	  if (!document.getElementById('br_contg_target').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_contg_target').focus();
                 return false;
      }
	  if (!document.getElementById('br_contg_tomonth').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_contg_tomonth').focus();
                 return false;
      }
	  if (!document.getElementById('br_contg_upto').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_contg_upto').focus();
                 return false;
      }
	   if (!document.getElementById('br_others_target').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_others_target').focus();
                 return false;
      }
	  if (!document.getElementById('br_others_tomonth').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_others_tomonth').focus();
                 return false;
      }
	  if (!document.getElementById('br_others_upto').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
	  ...
	  if (!document.getElementById('br_con_upto_1').value.match(numericExpression))
      {
	    ...
	    if (!document.getElementById('br_contg_target_1').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_contg_target_1').focus();
                 return false;
      }
	  if (!document.getElementById('br_contg_tomonth_1').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_contg_tomonth_1').focus();
                 return false;
      }
	  if (!document.getElementById('br_contg_upto_1').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_contg_upto_1').focus();
                 return false;
      }
	   if (!document.getElementById('br_others_target_1').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_others_target_1').focus();
                 return false;
      }
	  if (!document.getElementById('br_others_tomonth_1').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_others_tomonth_1').focus();
                 return false;
      }
	  if (!document.getElementById('br_others_upto_1').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
	  ...
	  if (!document.getElementById('br_contg_tomonth_2').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_contg_tomonth_2').focus();
                 return false;
      }
	  if (!document.getElementById('br_contg_upto_2').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_contg_upto_2').focus();
                 return false;
      }
	   if (!document.getElementById('br_others_target_2').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_others_target_2').focus();
                 return false;
      }
	  if (!document.getElementById('br_others_tomonth_2').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_others_tomonth_2').focus();
                 return false;
      }
	  if (!document.getElementById('br_others_upto_2').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
	 ...
	 if (!document.getElementById('br_hardware_target_3').value.match(numericExpression))
	  ...
	  if (!document.getElementById('br_con_upto_3').value.match(numericExpression))
      {
	   ...
	   if (!document.getElementById('br_contg_target_3').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_contg_target_3').focus();
                 return false;
      }
	  if (!document.getElementById('br_contg_tomonth_3').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_contg_tomonth_3').focus();
                 return false;
      }
	  if (!document.getElementById('br_contg_upto_3').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_contg_upto_3').focus();
                 return false;
      }
	   if (!document.getElementById('br_others_target_3').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_others_target_3').focus();
                 return false;
      }
	  if (!document.getElementById('br_others_tomonth_3').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_others_tomonth_3').focus();
                 return false;
      }
	  if (!document.getElementById('br_others_upto_3').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_others_upto_3').focus();
                 return false;
      }
	  if (!document.getElementById('br_contg_target_2').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
	  ...
	  if (!document.getElementById('br_con_upto_4').value.match(numericExpression))
      {
                 ...
                 return false;
      }if (!document.getElementById('br_contg_target_4').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_contg_target_4').focus();
                 return false;
      }
	  if (!document.getElementById('br_contg_tomonth_4').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_contg_tomonth_4').focus();
                 return false;
      }
	  if (!document.getElementById('br_contg_upto_4').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_contg_upto_4').focus();
                 return false;
      }
	   if (!document.getElementById('br_others_target_4').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_others_target_4').focus();
                 return false;
      }
	  if (!document.getElementById('br_others_tomonth_4').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_others_tomonth_4').focus();
                 return false;
      }
	  if (!document.getElementById('br_others_upto_4').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
	 ...
	 if (!document.getElementById('br_contg_target_5').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_contg_target_5').focus();
                 return false;
      }
	  if (!document.getElementById('br_contg_tomonth_5').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_contg_tomonth_5').focus();
                 return false;
      }
	  if (!document.getElementById('br_contg_upto_5').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_contg_upto_5').focus();
                 return false;
      }
	   if (!document.getElementById('br_others_target_5').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_others_target_5').focus();
                 return false;
      }
	  if (!document.getElementById('br_others_tomonth_5').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
                 document.getElementById('br_others_tomonth_5').focus();
                 return false;
      }
	  if (!document.getElementById('br_others_upto_5').value.match(numericExpression))
      {
                 alert("Please insert numeric value in  Field!");
