<%-- 
    Document   : EGS_view
    Created on : Apr 10, 2018, 11:12:22 AM
    Author     : Senet
--%>
...
psmnt = connection.prepareStatement("insert into egs_file(egsId, email, token, file, time, replyType) values(?, ?, ?, ?, ?, ?)");
...
String decleration="yes";
    ...
    try
        ...
        st=con.createStatement();
        String sql="insert into egs_basic values('"+email+"','"+mainKey+"','"+token+"','"+name+"','"+discipline+"','"+designation+"','"+cur_posting+"','"+dob+"','"+doj+"','"+time+"','"+InstId+"')";
        int res=st.executeUpdate(sql);

        String sql1="insert into egs_data values('"+token+"','"+mainKey+"','"+email+"','"+grType+"','"+otherDetail+"','"+decleration+"')";
        int res1=st.executeUpdate(sql1);

        String sql3="insert into egs_logindata values('"+token+"','"+mainKey+"','"+email+"','"+Status+"')";
...
else if(InstId.equals("I4") || InstId.equals("I5")){submit_ofc_name="MSME-DI Allahabad";}
    ...
    <body>
        <form action="" name="" id="">
            ...
            <table align="center" width="1050px"  id="mainTable1">
                <tr>
                    <td class="logout" align="right"><a HREF="EGS_main.jsp" >Home</a>&nbsp;&nbsp;&nbsp;<a HREF="EGS_logout.jsp" >Logout</a></td>
                </tr>
            </table>
                        ...
                        <table>
                            ...
                            <%
                                ...
                                try{
                                    con=ConnectionManager.getConnectionDirectForMySQL();
                                    st=con.createStatement();
                                    String data="Select * from egs_file where email='"+email+"'";
