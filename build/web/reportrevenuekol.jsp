...
%>
  <tr>
	...
	<td class="tablecontent1"><%=rsAdminResult.getString("branch4")%></td>
	 ...
	 <td class="tablecontent1"><%=((rsAdminResult.getInt("msmedi"))+(rsAdminResult.getInt("branch1"))+(rsAdminResult.getInt("branch2"))+(rsAdminResult.getInt("branch3"))+(rsAdminResult.getInt("branch4")))%></td>
  </tr>
