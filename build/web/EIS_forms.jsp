...
<html>
    ...
    <body style="margin-top: 0px;">
        <div style="width: 1290px; margin: auto; border: 1px solid #cacaca; background-color: #ffffff;">
                            ...
                            <div align="center">
                                <table width="50%" align="center">
                                    <tr>
                                        ...
                                        <td align="left" style="margin-left: 2px;"><input type="submit" name="action" onclick="return saveEis();" value="Final Submit"></td>
                                    </tr>
                                </table>
    ...
    //String email="rgvjee@gmail.com";
                ...
                <form name="update" action="" id="UpdateForm" method="POST">
                    <td align="center" style="width: 100%;">
                        <input type="button" class="btn1" id="btn" value="Update other details" onclick="return updateInfo()"/>     
                        <input type="button" class="btn" id="btn" value="Print" onclick="window.print()"/>
                    </td>
                </form>
                </tr>
            </table>
                        ...
                        <option value='Promotion'>Promotion</option>\n\
                                                    ...
                                                    function saveEis()
                                                    {
                                                        ...
                                                        else if (post1 == post2 || post2 == post3 || post1 == post3)
                                                        {
                                                            ...
                                                            var con = confirm('There is no edit option once you final submit. Are you sure you want to continue.');
                                                            if (con == true)
                                                            {
                                                    ...
                                                    function myFunction()
                                                    {
                                                        ...
                                                        if (Category == "" || Category == null) {
                                                            ...
                                                            var con = "You are going to save your details as draft, you can edit it later on. Are you sure want to continue ?";
                                                            var con1 = confirm(con);
                                                            if (con1 === true)
                                                            {
                                                                alert("yes");
