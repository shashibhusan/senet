<%-- 
    Document   : EGS_TRANSFER
    Created on : May 14, 2018, 2:05:42 PM
    Author     : Senet
--%>
...
try
    ...
    String Query="select * from egs_transfertohq where grvId='"+grvId+"'";
...
psmt = connection.prepareStatement("insert into egs_transfertohq(grvId, adEmail, userEmail, Time, transferFrom, status, reason, token) values (?, ?, ?, ?, ?, ?, ?, ?)");
