<%-- 
    Document   : ss_login
    Created on : May 18, 2018, 1:49:28 PM
    Author     : Senet
--%>
...
div {
    border-radius: 5px;
        ...
        <script>
           ...
           return false;
               ...
               {
           document.forms[0].action = "EIS_ss_login_check.jsp"
           return true;
               }
           }
        </script>
    ...
    <body bgcolor="#e7e7e7">
        <div style=" width: 520px; margin: 0 auto; border: 0.5px #b6b94e solid; background: white;">
       ...
       <div style="font-size:14px;font-family:Verdana;font-weight:bold; background:  #64bb64; padding-top: 5px; padding-bottom: 5px; " align="center" ><font color="#990000">ALL INDIA MSME-DO EMPLOYEES' INFORMATION SYSTEM SS</font>
         </div>
       <br/>
         ...
         <table  align="center" border="0px;">
             <tr>
                 <td align="center">
                   <strong style=" font-size: 20px; font-weight: 100;  font-family:sans-serif;"><b>EIS SS Login</b></strong>
                 </td>
             </tr>
             <tr>
                 <td>&nbsp;</td>
...
<br/>
 ...
 <div for="lname" align="left" class="data">Enter Captcha :<br/>
     <img id="captcha" style=" margin-left: 70px" src="<c:url value="Cap_Img.jsp" />" width="150"><a href="JavaScript:window.location.href=window.location.href"><img src="refresh.png" style="border:none" width="20" height="25"/></a> <br>
 <input type="text" class="captcha" name="answer" align="right" /><br></div>
    ...
    <br/><br>
    <h4 align="center">Not registered yet! <a href="ss_registration.jsp"> Register.</a></h4>
  </form>
<br/><br/>
