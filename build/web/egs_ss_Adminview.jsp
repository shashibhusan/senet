<%-- 
    Document   : admin_View
    Created on : May 23, 2018, 12:07:50 PM
    Author     : Senet
--%>
...
var url="EGS_SS_TRANSFER.jsp?val="+adEmail+"&val1="+grvId+"&val2="+userEmail+"&val3="+instId+"&val4="+token+"&reason="+reason;
...
function submitReply()
{
    ...
    {
        document.forms[0].action = "ss_submitFile.jsp?type_of_reply="+replyType;
  return true;
    }
...
.note1{
    ...
    <%
    System.out.println("=====we are on ss admin view page====");
...
String realTime="";
    ...
    try{
        String Query="select * from egs_ss_transfertohq where userEmail='"+email+"'";
...
System.out.println("Transfer value==="+iTransfer);
    ...
    int token=0;
            ...
            con=ConnectionManager.getConnectionDirectForMySQL();
            st=con.createStatement();
            String Query="select * from egs_ss_basic a join egs_ss_data b on a.token=b.token where a.email='"+email+"' ";
        ...
        <form name="reForm" action="" id="reForm" method="post" enctype="multipart/form-data">
            ...
            <center><p class="mainHeading">Acknowledgement (System Generated) - SS</center>
                        ...
                        <table>
                            <tr>
                                ...
                                <td width="550px" align="left" class="Div_two">
                                  ...
                                  <div class="data">
                                    ...
                                    <div class="data">
                                        Category &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;<%=rs.getString("a.category")%>
                                    </div>
                                    <br/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                try{
                                    con=ConnectionManager.getConnectionDirectForMySQL();
                                    st=con.createStatement();
                                    String data="Select * from egs_ss_file where egsId='"+grvId+"' and token='"+token+"'";
 ...
 %>
 <tr>
     <td align="left" style="padding-left: 155px; font-family: Bookman Old Style; font-size: 16px;">
