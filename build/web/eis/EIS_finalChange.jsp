<%-- 
    Document   : EIS_finalChange
    Created on : Feb 23, 2018, 5:31:27 PM
    Author     : Senet
--%>
...
String  sql12 ="insert into eis_finalchange values ('"+email+"','"+finalSubmit+"','"+time+"')";
...
if(flag==1)
    {
    %>
                  <jsp:forward page="EIS_adfSuccess.jsp" />
        <%
 ...
 //response.sendRedirect("/mprsenet/EIS_fSuccess.jsp");
   ...
   {
    %>
                  <jsp:forward page="EIS_adfSubmit.jsp" />
        <%
