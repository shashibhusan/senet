<%-- 
    Document   : EGS_reply_by_user
    Created on : Apr 24, 2018, 10:28:10 AM
    Author     : Senet
--%>
...
String sql ="insert into egs_reply values ('"+email+"','"+grvId+"','"+userEmail+"','"+token+"','"+reply+"','"+time+"')";
                ...
                <td>
                    <table width="450px;" id="msg" align="center">
                        <tr>
                            ...
                            <td align="center"><a href="EGS_userView.jsp">Home </a></td>
                            <td align="center"><a href="EGS_logout.jsp">Logout </a></td>
                        </tr>
                    </table>
