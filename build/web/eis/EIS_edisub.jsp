<%-- 
    Document   : EIS_edisub
    Created on : Feb 23, 2018, 11:16:09 AM
    Author     : Senet
--%>
...
a:active {
    text-decoration: none;
     ...
     <body>
       ...
       <div style="font-size:14px;font-family:Verdana;font-weight:bold; background:  #64bb64; padding-top: 5px; padding-bottom: 5px; " align="center" ><font color="#990000">ALL INDIA MSME-DO EMPLOYEES' INFORMATION SYSTEM </font>
         </div>
         <div align="center" title="Reciept" class="box">
             <h5 align="right"><a HREF="EISadlogout.jsp" > <strong>Logout</strong></a></h5>
   ...
   if (!Crosssite.equals(null))
    {
       ...
       System.out.println("We are in edit mode ::"+email);
...
System.out.println("training detail  :"+tp_det_3);
    //* End * //
        ...
        if(DOB=="" || DOB.equals(null))
        {
        DOB="0";
    }
        String doj_gov =request.getParameter("doj_gov");
        if(doj_gov=="" || doj_gov.equals(null))
        {
        doj_gov="0";
    }
        String doj_msme =request.getParameter("doj_msme");
        if(doj_msme=="" || doj_msme.equals(null))
        {
        doj_msme="0";
    }
        String dat_ret =request.getParameter("dat_ret");
        if(dat_ret=="" || dat_ret.equals(null))
        {
        dat_ret="0";
    }
        String bas_descipline =request.getParameter("bas_descipline");
        if(bas_descipline=="" || bas_descipline.equals(null))
        {
        bas_descipline="0";
    }
        String name1=request.getParameter("bas_name");
         if(name1=="" || name1.equals(null))
        {
        name1="0";
    }
        String designation=request.getParameter("bas_designation");
     if(designation=="" || designation.equals(null))
        {
        designation="0";
    }
        //Newly Created
        String CrPayLevel =request.getParameter("CrPayLevel");
        if(CrPayLevel=="" || CrPayLevel.equals(null))
        {
        CrPayLevel="0";
    }
        String aptPrPost =request.getParameter("aptPrPost");
        if(aptPrPost=="" || aptPrPost.equals(null))
        {
        aptPrPost="0";
    }
        String payLevelSub =request.getParameter("payLevelSub");
        if(payLevelSub=="" || payLevelSub.equals(null))
        {
        payLevelSub="0";
    }
        String Category =request.getParameter("Category");
        if(Category=="" || Category.equals(null))
        {
        Category="0";
    }
...
String time=dateFormat.format(date);
        ...
        try{
            Connection con = DriverManager.getConnection(connectionUrl+dbName, userId, password);
            Statement st=con.createStatement();
            String sql21="update eis_basicinfo set name='"+name1+"',bas_designation='"+designation+"',dob='"+DOB+"',dat_ret='"+dat_ret+"',bas_descipline='"+bas_descipline+"',doj_gov='"+doj_gov+"',doj_msme='"+doj_msme+"',CrPayLevel='"+CrPayLevel+"',aptPrPost='"+aptPrPost+"',payLevelSub='"+payLevelSub+"',Category='"+Category+"' " +
                    "where email='"+email+"'";
          int  rs23=st.executeUpdate(sql21);
          String sql22="insert into eis_change values ('"+adUserOfc+"','"+adEmail+"','"+adUser+"','"+email+"','"+name1+"','"+time+"')";
          int  rs24=st.executeUpdate(sql22);
          }
        catch(Exception ex){
                ex.printStackTrace();
                }
        ...
        if(Trade=="" || Trade.equals(null))
        {
        Trade="Select";
    }
        String splTrade=request.getParameter("splTrade");
        if(splTrade=="" || splTrade.equals(null))
        {
        splTrade="0";
    }
        String splOTrade=request.getParameter("splOTrade");
        if(splOTrade=="" || splOTrade.equals(null))
        {
        splOTrade="0";
    }
        String phyFit=request.getParameter("phyFit");
        if(phyFit=="" || phyFit.equals(null))
        {
        phyFit="0";
    }
        String qualification=request.getParameter("qualification");
        if(qualification=="" || qualification.equals(null))
        {
        qualification="0";
    }
        System.out.println("qualification=="+qualification);
        String hobbies=request.getParameter("hobbies");
        if(hobbies=="" || hobbies.equals(null))
        {
        hobbies="0";
    }
...
<tr>
        <td class="success">
           Hello <%=adUser%> !
            ...
            <tr>
                <td class="success"><br/> Your data saved as been edited successfully. </td>
            </tr>
            ...
            <td align="center" class="success"><br/>
                <button type="submit" size="43" value="" > &nbsp;&nbsp;&nbsp;&nbsp;Go to Homepage&nbsp;&nbsp;&nbsp;&nbsp;</button>
            </td>
        </tr>
   ...
   {
%>
<form method="post" action="" onsubmit="return fail()">
<tr>
    <td align="center" style=" color: red; font-weight: bold;" >
        <img src="alert.png" width="45" height="45" />  <br/><br/>    Email is already in our record. Please try different.
        </td>
    </tr>
    <tr>
        <td align="center">
