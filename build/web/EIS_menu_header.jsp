...
<html>
    <head>
        ...
        <style>
            ...
            li{font: normal normal 12px Verdana, Geneva, Arial, Helvetica, sans-serif;}
            #innerDiv1-one
            {
                float: left;
                width: 20%;
                ...
                <ul>
                    ...
                    <li id="link" class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <a class="li-ele" href="EIS_instwise.jsp">Institute Wise Data</a>
                            <%--
                            <a class="li-ele" href="EIS_updatedPref.jsp">Updated Preference List</a>
                            --%>
                            <a class="li-ele" href="EIS_report_BySelecting_Inst.jsp">Discipline Wise Report</a>
                        </div>
                    </li>
                    <%--    
                    ...
                    <li id="link" class="dropdown">
                        ...
                        <div class="dropdown-content">
                        <a class="li-ele" href="preferenceReport.jsp">by selection wise</a>  
                        <a class="li-ele" href="preferenceReportMain.jsp">Preference Updated Report 2021-2022</a>
                            </div>
                    </li>
                    <li id="link"><a href="searchInfo.jsp">Search</a></li>
                   
                    <%--
                    <li id="link"><a href="listofupdateddetails.jsp">Updated Details</a></li>
                    --%>
                    <li id="link" class="right"><a HREF="EISadlogout.jsp" >Logout</a></li>
