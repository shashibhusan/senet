<%-- 
    Document   : EGS_reply_by_Hqtr
    Created on : Apr 24, 2018, 2:05:34 PM
    Author     : Senet
--%>
...
String replyType=request.getParameter("type_of_reply");
System.out.println("Reply type used by admin :="+replyType);
...
try{
    ...
    String sql="select * from egs_basic where email='"+email+"'";
...
String sql ="insert into egs_reply values ('"+adEmail+"','"+grvId+"','"+userEmail+"','"+token+"','"+reply+"','"+time+"')";
                ...
                <td>
                    <table width="450px;" id="msg" align="center">
                        <tr>
                            ...
                            <td align="center"><a href="EGS_Grievance_Hqtr.jsp">Home </a></td>
                            <td align="center"><a href="EISadlogout.jsp">Logout </a></td>
                        </tr>
                    </table>
